    ...
    return(
        <div className="container">   
            ...
            <h5 className="font-weight-bold m-4 ">Last revised: [20 March 2020]</h5>
                ...
                content accessible or downloadable from the Site, and (ii) any other PuniPuni Studio application,
                 ...
                 We are committed to protecting and respecting your privacy. This Privacy Policy
                  (“Policy”) describes how we treat information that you provide to us or that
                   we collect about you. By “Personal Data”, we refer to data that relates to you
                    as an identified or identifiable natural person. Personal Data include your name,
                     your address, your telephone number, your email address, your age, your gender,
                      or a part of your credit card number, for instance. Anonymous information, 
                      which we are not in a position to relate to you, does not qualify as Personal Data.</p>
            <h5 className="font-weight-bold m-1">1. Controller’s name and contact details</h5>
                <p> 
            ...
            <p> We process Personal Data only when necessary for the performance of a contract with you, 
                ...
                or based on our legitimate interests, except where such interests are overridden by the 
                interests or fundamental rights and freedoms of you which require the protection of your 
                Personal Data. This section applies to all detailed processing activities listed below.</p>
            <h5 className="font-weight-bold m-1">3.1 Information Security</h5>
            <p> We and our employees understand the need for user privacy, and we maintain reasonable and appropriate security procedures to protect your information from loss, misuse and unauthorized access, disclosure, alteration and destruction, taking into due account the risks involved in the processing and the nature of the Personal Data. Access to user data is strictly limited to specific individuals who are trained to respect user privacy. The access given to these employees is restricted to their need for such information for business purposes. A log of those who accessed the data is maintained and monitored to prevent security breaches.</p>
            <h5 className="font-weight-bold m-1">3.2 Third-party information storage</h5>
            ...
            <h5 className="font-weight-bold m-1">3.3 Children</h5>
            <p> We recognise that we have a special obligation to protect personal information obtained from children. We will not knowingly collect personal information from any child, or process such information, without parental consent. For the purpose of this Policy, a child means any individual who is under the age of 16 (or the minimum legal age to consent to the collection and processing of personal information where this is different under applicable law).</p>
            <h5 className="font-weight-bold m-1">3.4 Retention periods</h5>
            <p> We will retain your Personal Data only as long as it is necessary to fulfil the respective purpose, unless we are required by law to store your Personal Data longer.</p>
            <h5 className="font-weight-bold m-1">4. Use of our Site</h5>
            <p> On our Site, we gather information either directly from you (e.g., when you provide certain information to us) or indirectly (e.g., through our Site’s technology).</p>
            <h5 className="font-weight-bold m-1">4.1. Information collected indirectly</h5>
            <p> We indirectly collect a variety of information through your interaction with and use of our Sites. This information may include, but is not limited to, browser settings, data collected through automated electronic interactions, application usage data, demographic information, geographic or geo-location information, statistical and aggregated information (“Other Information”). The processing is necessary for the purpose of our legitimate interests in accordance with Article 6(1)(f) of the GDPR, as we need this information to keep user data safe by detecting certain threats, and to provide you with the best possible experience. Statistical or aggregated information does not directly identify a specific person, but it may be derived from Personal Data. For example, we may aggregate Personal Data to calculate the percentage of users in a particular country. If we combine Other Information with Personal Data, we will treat the combined information as Personal Data.</p>
            <h5 className="font-weight-bold m-1">4.1.1 Tracking Data</h5>
            <p> Website traffic volume and patterns, such as the number of visitors to a given website or page on a daily basis is typically referred to as “Tracking Data”. This type of indirectly collected information is gathered through various means, such as an IP address, which is a number that is automatically assigned to your computer whenever you are surfing the Web. Web servers, the computers that “serve up” web pages, automatically identify your computer by its IP address. When you visit any of our Sites, our servers log your computer’s IP address. To obtain these Tracking Data, we use third party analytics providers. The Third Party Analytics Providers use “Cookies”, which are text files placed on your computer, to help us analyse how users use our Sites. The information generated by the Cookie about your use of our Sites, including your IP address, will be transmitted to and stored by Third Party Analytics Providers’ servers. On our behalf, the Third Party Analytics Providers will use this information for the purpose of evaluating your use of our Sites, compiling reports on website activity, and providing other services relating to website activity. The Third Party Analytics Providers will not associate your IP address with any other data held by them. You may find information on our Third Party Analytics Provider in section 8 below and a list of Cookies used by them in section 9 below.</p>
            <h5 className="font-weight-bold m-1">4.1.2 Our Cookies</h5>
            <p> Other types of indirectly collected information are stored in Cookies from us. Some of our Sites use Cookies simply to store your account details so that you do not need to re-enter your information when re-joining our Sites. The use of Cookies is standard on the internet. Although most Web browsers automatically accept Cookies, the decision of whether to accept or not is yours. You may adjust your browser settings to prevent the reception of Cookies, or to provide notification whenever a Cookie is sent to you. You may refuse the use of Cookies by selecting the appropriate settings on your browser. However, please note that if you do this, you may not be able to access the full functionality of our Sites. Cookies placed by us will expire when you terminate the website session or after a reasonable period of inactivity. You may find a list of the Cookies used in section 9 below.</p>
            <h5 className="font-weight-bold m-1">4.1.3 Third-party Cookies</h5>
            <p> Additionally, we may use third-party advertising companies to serve ads on our behalf. These companies may use Cookies and action tags to measure advertising effectiveness. You can still decide whether you want to accept these Cookies. You may adjust your browser settings to prevent the reception of third-party Cookies, or to provide notification whenever such third-party Cookies are sent to you. We use the following third-party Cookies: You may find a list of Cookies used in section 9 below.</p>
            <h5 className="font-weight-bold m-1">4.2. Information collected directly</h5>
            <p> We also collect Personal Data and other information that you voluntarily provide. It is entirely your decision to provide the requested information. However, certain features of our Sites may not be available in this case. We keep all information collected directly confidential, and will only use the information for the particular purpose it is collected for. We will seek your specific permission for any additional use. We will never barter, trade, or sell access to your information without your specific consent.</p>
            <h5 className="font-weight-bold m-1">4.2.1 User Accounts</h5>
            <p> When setting up an account on one of our Sites (“User Account”), you may be asked to provide Personal Data including, but not limited to, your name, email address, and your phone number. If you choose to purchase any products, services, access codes or other items for sale by us, you will be asked to provide payment details and your full address for billing purposes. As a user of our Sites, we may obtain your Personal Data when you register to use our Site or services and products or when you provide feedback about our products or services. The processing is necessary to perform the contract with you according to Article 6(1)(b) of the GDPR. As a user, we will use your Personal Data, unless otherwise prohibited by law, for the following purposes: To provide you with the products and services you request. To communicate with you about your account or transactions with us and send you information about features on our sites or changes to our policies. To provide support including, but not limited to, product updates, product patches and fixes and other similar communications. Furthermore, we will use your Personal Data for our legitimate interests according to Article 6(1)(f) of the GDPR to notify you about information about features on our Sites, new product releases and service developments and to advertise our products and services in accordance with this Policy. Any User Account data will only be stored until you decide to terminate your User Account. In case we are obliged to further store your Personal Data due to statutory retention requirements, your Personal Data will be barred for further use by us and only stored until such retention periods expire.</p>
            <h5 className="font-weight-bold m-1">4.2.2 Personal Data provided by other means</h5>
            <p> Personal Data provided by you on our Sites by other means, e.g., via contact forms, will be stored in our service database and retained for the period necessary to fulfil the business our contractual obligations to you in accordance with Art. 6(1)(b) of the GDPR, unless a longer retention period is required by law.</p>
            <h5 className="font-weight-bold m-1">4.3 Third country transfers</h5>
            <p> We transfer Personal Data for hosting purposes to the USA. This transfer is safeguarded by Data Processing Agreements with data protection guarantees and the EU-US Privacy Shield, as the recipients are certified under this framework. To receive a copy of the respective safeguards, please contact us at privacy@punipunistudios.com.</p>
            <h5 className="font-weight-bold m-1">5. Our Games</h5>
            <p> This section provides information on how we we treat information that you provide to us or
                 that we collect about you in regard to our games: “From Hell”,
                  “Puzzyles”, “Fate Gunz” (our “Games”). 
                 When you are playing one of our Games, we process your IP address,
                and metrics on how you use our games, this is information on how long you play our 
                Games and how you play them. We will also process game events, like achievements,
                milestones or other timestamps within the game. This Personal Data is necessary for
                us to provide you with the Games and their full functionality. The legal basis for 
                processing the data is our contract with you (Art. 6(1)(b) of the GDPR). Where the 
                processing exceeds the necessity to fulfil our contract (when analysing how you use 
                our game for the purpose of enhancing your game experience), the legal basis is our l
                egitimate interest (Art. 6(1)(f) of the GDPR) to improve the Games for your future 
                enjoyment. For billing purposes, we process your name, your email and postal address
                and your credit or debit card number, depending on which payment you choose. 
                The basis for the processing of this Personal Data is also our contract with you 
                (Art. 6(1)(b) of the GDPR), and our legal requirement to store this information 
                for tax reasons (Art. 6(1)(c) of the GDPR). The provision of all of the Personal 
                Data is a contractual requirement, as we may not provide you with our Games or to
                carry out any payments by you. We transfer Personal Data for billing purposes to t
...
To exercise the rights referred to above, please contact us at privacy@punipuni.studio. You may take legal actions in relation to any breach of your rights regarding the processing of the Personal Data, as well as to lodge complaints with the competent authority.</p>
            ...
            <p> We may change this Policy from time to time for various reasons such as changes to reflect in law and regulation, changes in industry practices and technological developments.</p>
